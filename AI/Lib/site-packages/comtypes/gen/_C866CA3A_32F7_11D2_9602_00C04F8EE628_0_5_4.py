...
__all__ = [
    ...
    'DISPID_SRSetPropertyNumber', 'SRARoot', 'SVESentenceBoundary',
    ...
    'SPSUnknown', 'SpeechAddRemoveWord', 'DISPID_SRGetRecognizers',
    'SAFTADPCM_8kHzMono', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SpeechPhraseAlternate',
    'SPSEMANTICFORMAT', 'ISpeechAudio',
    ...
    'SP_VISEME_4', 'DISPID_SRCCreateGrammar', 'SPAS_PAUSE',
    'SPEI_SR_BOOKMARK', 'eLEXTYPE_PRIVATE19', 'SP_VISEME_2', 'SVP_21',
    'SLTUser', 'SREPropertyStringChange', 'SPAR_High',
    'SAFTNonStandardFormat', 'DISPID_SGRsItem', 'DISPID_SASState',
    'SSFMCreate', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SP_VISEME_21',
    'SPRST_INACTIVE', 'ISpeechMemoryStream', 'SPINTERFERENCE_TOOSLOW',
    'DISPID_SRProfile', 'SpeechRecoProfileProperties',
    'SpeechRecoEvents', 'SAFT8kHz8BitMono', 'SpeechRecoContextState',
    'SPSModifier', 'DISPID_SVSPhonemeId', 'DISPID_SRCERecognition',
    'SGDisplay', 'SPWORDLIST', 'DISPID_SLPLangId', 'DISPIDSPTSI',
    'DISPID_SABufferNotifySize', 'SRESoundStart',
    'SpeechRuleAttributes', 'DISPID_SGRSTsCount',
    'DISPID_SRRPhraseInfo', 'SRATopLevel', 'SRAExport',
    'DISPID_SVSkip', 'SPEI_SOUND_END', 'DISPID_SpeechAudio',
    ...
    'DISPID_SVWaitUntilDone', 'ISpRecoGrammar2', 'SVF_Emphasis',
    'DISPID_SRGCommit', 'eLEXTYPE_RESERVED9', 'SRADefaultToActive',
    ...
    'ISpEventSink', 'SpeechDiscardType', 'ISpDataKey', 'SRCS_Enabled',
    'DISPID_SpeechVoiceStatus', 'SpUnCompressedLexicon',
    'SVEAllEvents', '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SLTApp',
    'SpeechGrammarState', 'DISPID_SpeechAudioStatus',
    'DISPID_SRAudioInput', 'SPCT_SUB_DICTATION', 'SPEI_TTS_BOOKMARK',
    'DISPID_SRRSpeakAudio', 'UINT_PTR', 'DISPID_SFSOpen',
    'SpeechEngineProperties', 'SRCS_Disabled', 'SVSFVoiceMask',
    'SPGRAMMARWORDTYPE', 'ISpeechFileStream',
    'DISPIDSPTSI_SelectionLength', 'DISPID_SVEStreamStart',
    'DISPID_SRGState', 'DISPID_SPILanguageId', 'DISPID_SVEStreamEnd',
    'SpeechRegistryLocalMachineRoot', 'SVP_8', 'DISPID_SGRSTRule',
    'SPWORDPRONOUNCEABLE', 'SVP_13', 'DISPID_SBSWrite',
    'ISequentialStream', 'ISpPhoneConverter',
    'DISPID_SpeechMemoryStream', 'ISpeechPhoneConverter',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SDKSetBinaryValue',
    'SPWT_PRONUNCIATION', 'SPSMF_UPS',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SPRuleFirstElement', 'SPPHRASEELEMENT',
    'DISPID_SPRsCount', 'DISPID_SpeechBaseStream',
    'DISPID_SRRSetTextFeedback', 'SVEPhoneme', 'DISPID_SPIGrammarId',
    'DISPID_SPRuleConfidence', 'SAFT44kHz16BitMono',
    'DISPID_SGRSTType', 'SPAR_Unknown', 'SRAInterpreter',
    'DISPID_SPIReplacements', 'SPWORDPRONUNCIATION', 'SPGS_EXCLUSIVE',
    'SAFTCCITT_ALaw_22kHzMono', 'SDTAlternates', 'SRESoundEnd',
    'SPSHORTCUTTYPE', 'SpMMAudioEnum', 'DISPID_SRIsShared',
    'SAFT44kHz8BitMono', 'DISPID_SGRSAddWordTransition',
    'DISPID_SGRSTPropertyValue', 'SRSEIsSpeaking', 'SpShortcut',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpNotifyTranslator',
    'DISPID_SRGetPropertyString', 'SPRECORESULTTIMES',
    'DISPID_SPIRetainedSizeBytes', 'SpeechTokenKeyFiles',
    'DISPID_SLWsCount', 'SVP_9', 'DISPID_SpeechCustomStream',
    'SPPS_RESERVED1', 'DISPID_SDKGetBinaryValue',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'eLEXTYPE_RESERVED6',
    'DISPID_SOTId', 'ISpeechBaseStream', 'SINone', 'ISpRecognizer3',
    'SpCustomStream', 'SPEI_HYPOTHESIS', 'SWTAdded', 'SDTLexicalForm',
    'SPEI_TTS_PRIVATE', 'SP_VISEME_14', 'ISpeechVoiceStatus',
    'SPWF_INPUT', 'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SGRSTWeight',
    'DISPID_SOTCDefault', 'SECLowConfidence', 'SREAdaptation',
    'ISpSerializeState', 'DISPID_SpeechLexiconWords',
    'DISPID_SVEPhoneme', 'DISPID_SRCEAudioLevel', 'SpMemoryStream',
    'DISPID_SPPEngineConfidence', 'DISPID_SPELexicalForm',
    'DISPID_SGRsCount', 'SGRSTTTextBuffer', 'SPLO_DYNAMIC',
    'ISpObjectTokenCategory', 'SPRECOSTATE',
    'DISPID_SpeechAudioFormat', 'ISpLexicon', 'SRTEmulated',
    ...
    'SpeechBookmarkOptions', 'SPDATAKEYLOCATION', 'SASStop',
    'SAFTCCITT_uLaw_8kHzMono', 'eLEXTYPE_PRIVATE18',
    'eLEXTYPE_PRIVATE5', 'SRAImport', 'SDKLLocalMachine',
    'SpeechCategoryVoices', 'ISpeechPhraseElements', 'SRSEDone',
    'SpLexicon', 'DISPID_SRRAudio', 'SVPOver',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SRRTStreamTime',
    'SPVOICESTATUS', 'ISpProperties', 'SVP_6', 'DISPID_SGRsCommit',
    'SPEI_REQUEST_UI', 'SPBO_PAUSE', 'DISPID_SPEAudioTimeOffset',
    'SpeechVisemeFeature', 'SpMMAudioOut', 'SpeechGrammarWordType',
    'SPRS_INACTIVE', 'DISPID_SLWWord', 'SAFTCCITT_uLaw_44kHzStereo',
    'SpeechAudioFormatType', 'ISpeechGrammarRules',
    'SPSERIALIZEDRESULT', 'DISPID_SPPsItem',
    'DISPID_SOTCreateInstance', 'SAFT8kHz8BitStereo', 'SPBO_AHEAD',
    'SPEI_SOUND_START', 'DISPID_SRGDictationUnload',
    'SpeechRegistryUserRoot', 'SITooSlow',
    'DISPID_SPIGetDisplayAttributes', 'SPEVENTENUM',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SRGRules', 'SPWORD',
    'SDA_One_Trailing_Space', 'SPSNotOverriden', 'SASPause',
    'SP_VISEME_5', 'STCRemoteServer', 'DISPID_SpeechFileStream',
    'SPRS_ACTIVE', 'SP_VISEME_6', 'SGPronounciation',
    'DISPID_SpeechRecoContextEvents', 'SpeechVoiceCategoryTTSRate',
    'ISpShortcut', 'DISPID_SPAsItem', 'DISPID_SLWLangId',
    'SAFTCCITT_uLaw_11kHzMono', 'SpPhraseInfoBuilder',
    'SPPS_SuppressWord', 'SVSFPersistXML', 'DISPID_SRRTTickCount',
    ...
    'DISPID_SLPs_NewEnum', 'SVEViseme', 'DISPID_SRGCmdLoadFromObject',
    'SpeechAudioVolume', 'SAFTCCITT_uLaw_22kHzStereo',
    'eLEXTYPE_USER', 'SRTExtendableParse', 'DISPID_SVSLastBookmarkId',
    'SAFTCCITT_ALaw_44kHzMono', 'DISPID_SRRAudioFormat',
    'DISPID_SMSALineId', 'DISPID_SPRs_NewEnum', 'SECFEmulateResult',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SADefaultFormat',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SWFESamplesPerSec', 'SDTProperty', 'SAFTGSM610_22kHzMono',
    'ISpeechRecoResultDispatch', 'DISPID_SpeechGrammarRule',
    'DISPID_SAFGuid', 'SPVPRI_NORMAL', 'DISPID_SPRDisplayAttributes',
    'SAFT12kHz16BitMono', 'ISpeechPhraseProperties',
    'DISPID_SLGenerationId', 'SVP_18', 'SAFTDefault',
    'ISpeechPhraseRule', 'SPXRO_SML', 'SPEI_MAX_SR',
    'DISPID_SPCLangId', 'SPEI_RECOGNITION', 'SPINTERFERENCE_TOOQUIET',
    'SGSDisabled', 'eLEXTYPE_PRIVATE8', 'ISpeechRecognizerStatus',
    'SPEI_FALSE_RECOGNITION', 'SPEI_MAX_TTS', 'ISpVoice',
    'DISPID_SDKGetlongValue', 'DISPID_SPPs_NewEnum', 'LONG_PTR',
    'SGRSTTDictation', 'ISpAudio', 'DISPID_SPRuleId', 'IStream',
    'SPSHORTCUTPAIR', 'SVP_12', 'SpeechStreamFileMode',
    'SVF_Stressed', 'ISpStream', 'SPRST_INACTIVE_WITH_PURGE',
    'eLEXTYPE_PRIVATE3', 'SPRST_ACTIVE_ALWAYS', 'ISpeechAudioFormat',
    'SSFMOpenReadWrite', 'SVP_0', 'SDTRule', 'SPBOOKMARKOPTIONS',
    'SPEI_RESERVED6', 'SPXMLRESULTOPTIONS', 'SRSActive',
    'SPEI_MIN_TTS', 'ISpeechRecoResult2',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SVPriority',
    'SPDKL_DefaultLocation', 'SPEI_UNDEFINED', 'SPEI_RESERVED3',
    'SpeechTokenKeyUI', 'SPLOADOPTIONS', 'ISpeechPhraseAlternates',
    'SpeechCategoryRecognizers', 'SLODynamic', 'SPCT_COMMAND',
    'DISPID_SRSCurrentStreamNumber', 'SPAS_RUN', 'SPFM_OPEN_READONLY',
    'SVSFParseMask', 'SPEI_SENTENCE_BOUNDARY', 'SPPHRASE',
    'SGDSActiveWithAutoPause', 'SPDKL_CurrentConfig',
    'SWPUnknownWordUnpronounceable', 'DISPID_SVGetAudioInputs',
    'DISPID_SRCEventInterests', 'DISPID_SGRInitialState',
    'DISPID_SGRName', 'ISpRecoResult', 'DISPID_SVSpeak',
    'DISPID_SRGetPropertyNumber', 'SpSharedRecognizer',
    'SVEVoiceChange', 'ISpeechGrammarRuleStateTransition',
    ...
    'DISPID_SPRText', 'Speech_Max_Pron_Length', 'DISPID_SBSRead',
    'SPPS_LMA', 'SVSFlagsAsync', 'DISPID_SAStatus',
    'SPSHORTCUTPAIRLIST', 'DISPID_SVSLastBookmark',
    'ISpeechPhraseElement', 'DISPID_SRCAudioInInterferenceStatus',
    'SpeechPropertyAdaptationOn', 'SDKLCurrentUser',
    'DISPID_SRCERequestUI', 'DISPID_SVEEnginePrivate',
    'SPPARTOFSPEECH', 'SPEI_PHRASE_START',
    'ISpeechTextSelectionInformation', 'DISPID_SpeechGrammarRules',
    'SPSHT_EMAIL', 'SWPKnownWordPronounceable', 'DISPID_SPEsCount',
    'SpInprocRecognizer', 'SVSFParseSsml', 'SRTAutopause', 'SPSVerb',
    'DISPID_SRState', 'DISPID_SPEEngineConfidence', 'SSTTTextBuffer',
    'SVP_2', 'SPLO_STATIC', 'SpeechRunState', 'DISPID_SABufferInfo',
    'SpeechPropertyHighConfidenceThreshold',
    '_ISpeechRecoContextEvents', 'DISPID_SOTCategory', 'SWTDeleted',
    'SREBookmark', 'SP_VISEME_11',
    ...
    'SPSTREAMFORMATTYPE', 'DISPID_SVSInputSentencePosition',
    'SpInProcRecoContext', 'DISPID_SpeechPhraseReplacements',
    'IEnumString', 'DISPID_SRCEPhraseStart',
    'DISPID_SpeechRecoResultTimes', 'SpStream', 'DISPID_SOTCId',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpResourceManager',
    'SPDKL_CurrentUser', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SVSRunningState', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SAVolume', 'SpeechVisemeType',
    'DISPID_SPERetainedStreamOffset', 'SVSFIsNotXML',
    'DISPID_SDKEnumValues', 'SPBINARYGRAMMAR',
    'ISpeechPhraseInfoBuilder', 'SP_VISEME_9', 'SpPhoneConverter',
    'ISpPhrase', 'SAFT12kHz8BitStereo', 'SPPS_RESERVED2',
    'SVSFNLPMask', 'SVP_7', 'SVP_15', 'DISPID_SVDisplayUI',
    'SAFT11kHz8BitStereo', 'SAFT11kHz16BitMono', 'SPFM_CREATE',
    'DISPID_SLWPronunciations', 'SPVPRIORITY',
    'SpeechTokenIdUserLexicon', 'ISpXMLRecoResult', 'SPSLMA',
    'DISPID_SAFGetWaveFormatEx', 'SPSHT_NotOverriden',
    'DISPID_SPAStartElementInResult', 'SPEI_SR_PRIVATE',
    'DISPID_SGRSTs_NewEnum', 'SAFT22kHz8BitMono', 'SP_VISEME_19',
    'STCAll', 'SpeechTokenContext', 'SpeechFormatType',
    'SpeechMicTraining', 'DISPID_SVSpeakStream', 'DISPID_SMSGetData',
    'DISPID_SVSInputWordPosition', 'SFTInput', 'SVSFNLPSpeakPunc',
    'DISPID_SpeechPhraseRule', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SpeechWaveFormatEx', 'SREHypothesis',
    'SAFT24kHz8BitStereo', 'DISPID_SVSInputWordLength',
    'DISPID_SRGetFormat', 'DISPID_SPCIdToPhone', 'SP_VISEME_0',
    'DISPID_SPEDisplayAttributes', 'DISPID_SpeechPhraseElement',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SPPNumberOfElements',
    'SpeechAllElements', 'SpMMAudioIn', 'SPAS_CLOSED',
    'SPFM_CREATE_ALWAYS', 'ISpNotifySink', 'DISPID_SPIEngineId',
    'SpeechPartOfSpeech', 'SAFTGSM610_8kHzMono', 'SVP_11', 'SVP_20',
    'SVEPrivate', 'SpeechVoicePriority', 'DISPID_SRGCmdLoadFromFile',
    'SAFT24kHz16BitStereo', 'SPFM_NUM_MODES',
    'DISPID_SpeechRecognizer', 'ISpeechRecoResultTimes',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SRCEEndStream',
    'eLEXTYPE_PRIVATE6', 'SREStateChange', 'DISPID_SPRsItem',
    'DISPID_SPPFirstElement', 'SGLexicalNoSpecialChars',
    'DISPID_SPRuleParent', 'DISPID_SVSLastResult', 'SGDSActive',
    'SpeechSpecialTransitionType', 'DISPID_SpeechRecoResult',
    'SVEWordBoundary', 'SPAS_STOP', 'SWPUnknownWordPronounceable',
    'DISPID_SPPConfidence', 'SpeechCategoryPhoneConverters',
    'eLEXTYPE_MORPHOLOGY', 'SPCATEGORYTYPE', 'SRTReSent',
    ...
    'eLEXTYPE_PRIVATE2', 'SRERequestUI', 'STCInprocHandler',
    'SPWAVEFORMATTYPE', 'SAFT16kHz8BitStereo',
    'DISPID_SpeechLexiconProns', 'DISPID_SRCESoundEnd',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SRAudioInputStream',
    'SpeechStreamSeekPositionType', 'DISPID_SRRTLength',
    'DISPID_SOTMatchesAttributes', 'Speech_StreamPos_RealTime',
    'SPRST_NUM_STATES', 'SREPhraseStart', 'SREAudioLevel',
    'SVEStartInputStream', 'SPRST_ACTIVE', 'DISPID_SPACommit',
    'DISPID_SWFEBitsPerSample', 'eLEXTYPE_RESERVED7',
    'DISPID_SRGReset', 'DISPID_SLWs_NewEnum',
    'SpeechGrammarTagUnlimitedDictation', 'SpObjectToken',
    'DISPID_SLAddPronunciation', 'tagSPTEXTSELECTIONINFO',
    'SRTSMLTimeout', 'SPCS_ENABLED', 'SPINTERFERENCE',
    'SPTEXTSELECTIONINFO', 'DISPID_SPRFirstElement',
    'SAFTTrueSpeech_8kHz1BitMono', 'ISpRecognizer2',
    'SPSEMANTICERRORINFO', 'SGRSTTEpsilon', 'SRSInactive',
    'eWORDTYPE_ADDED', 'DISPID_SGRSTsItem', 'ISpeechPhraseInfo',
    'SpeechVoiceSkipTypeSentence', 'SAFTADPCM_44kHzStereo',
    'SPEI_RECO_OTHER_CONTEXT', 'SPPS_Interjection', 'SVEBookmark',
    'DISPID_SRGRecoContext', 'SpWaveFormatEx',
    'IInternetSecurityManager', 'DISPID_SVGetVoices',
    'DISPID_SGRSTText', 'SBONone', 'DISPID_SRSAudioStatus',
    'SpeechDisplayAttributes', 'STSF_AppData',
    'DISPID_SPEPronunciation', 'DISPID_SGRClear', 'DISPID_SPAsCount',
    'DISPID_SGRSTransitions', 'SASRun', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SVRate', 'SVP_1', 'SPAUDIOOPTIONS',
    'DISPID_SVEAudioLevel', 'SPSMF_SAPI_PROPERTIES',
    'SpeechTokenShellFolder', 'SITooFast', 'DISPID_SGRSRule',
    ...
    'DISPID_SPANumberOfElementsInResult', 'SECFNoSpecialChars',
    'DISPID_SLWType', 'DISPID_SOTRemove', 'SPEI_VISEME',
    'SAFT16kHz16BitMono', 'DISPID_SRGCmdSetRuleIdState',
    'Speech_Default_Weight', 'SAFT22kHz16BitStereo', 'SP_VISEME_16',
    'SpeechCategoryRecoProfiles', 'SpeechCategoryAudioOut',
    'SPVISEMES', 'DISPID_SRGSetTextSelection', 'SVEAudioLevel',
    'DISPID_SpeechPhraseProperties', 'SDTReplacement',
    'DISPID_SPIElements', 'SAFT11kHz8BitMono', 'DISPID_SRCEBookmark',
    'SPGS_DISABLED', 'DISPID_SGRsDynamic', 'ISpObjectToken',
    'ISpNotifyTranslator', 'SAFTADPCM_11kHzMono', 'SPPROPERTYINFO',
    'SPPS_Verb', 'SAFTText', 'SAFTCCITT_ALaw_11kHzMono',
    'ISpeechMMSysAudio', 'SITooLoud', 'SSFMCreateForWrite',
    'SPBO_TIME_UNITS', 'ISpeechAudioStatus',
    'DISPID_SVEventInterests', 'ISpeechAudioBufferInfo', 'SGLexical',
    'SPEI_RESERVED1', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SVSFIsXML', '_RemotableHandle', 'STSF_CommonAppData',
    'SPEI_WORD_BOUNDARY', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SASNonBlockingIO', 'SGRSTTWord', 'SDA_No_Trailing_Space',
    'DISPID_SPPsCount', 'DISPID_SPPParent', 'DISPID_SPIStartTime',
    'DISPID_SVAudioOutput', 'SPWORDTYPE', 'SAFT16kHz8BitMono',
    'DISPID_SGRAddResource', 'SRERecoOtherContext',
    'ISpObjectWithToken', 'DISPID_SPRuleNumberOfElements',
    'SPCT_SUB_COMMAND', 'SPEI_PHONEME', 'SpeechTokenKeyAttributes',
    'DISPIDSPRG', 'DISPID_SRSSupportedLanguages', 'DISPID_SDKOpenKey',
    'SpeechRetainedAudioOptions', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SBSSeek', 'DISPID_SOTsCount', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SOTSetId', 'SPINTERFERENCE_NOISE', 'SREFalseRecognition',
    'SpAudioFormat', 'DISPID_SRCEPropertyStringChange',
    'STCLocalServer', '_SPAUDIOSTATE', 'SPEI_INTERFERENCE',
    'WAVEFORMATEX', 'SAFT16kHz16BitStereo', 'SAFT44kHz16BitStereo',
    'ISpeechPhraseReplacements', 'SAFT44kHz8BitStereo',
    'SECFIgnoreWidth', 'DISPID_SGRAddState',
    'ISpStreamFormatConverter', 'DISPID_SLPsItem', 'SPWT_LEXICAL',
    'DISPID_SVGetAudioOutputs', 'SPPS_RESERVED4', 'SPPS_Function',
    'SPAUDIOSTATE', 'DISPID_SpeechRecoContext', 'DISPID_SLWsItem',
    'DISPID_SPIRule', 'DISPID_SRStatus', 'DISPID_SPEAudioSizeTime',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SRCEStartStream',
    'DISPID_SVPause', 'SREPropertyNumChange',
    'DISPID_SLRemovePronunciation', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SASetState', 'DISPID_SPEActualConfidence',
    'SAFTADPCM_22kHzStereo', 'SPXRO_Alternates_SML', 'SPVPRI_OVER',
    'DISPID_SPIAudioSizeTime', 'DISPID_SDKDeleteKey',
    'SAFT12kHz8BitMono', 'SPCT_SLEEP', 'DISPID_SPRNumberOfElements',
    'DISPID_SPARecoResult', 'ISpeechPhraseReplacement',
    'DISPID_SGRSAddSpecialTransition', 'SPEVENTSOURCEINFO',
    'ISpeechCustomStream', 'SPPHRASEPROPERTY',
    ...
    'DISPID_SPPId', 'DISPID_SRIsUISupported', 'ISpEventSource',
    'SDTAll', 'ISpRecoContext2', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SGDSInactive', 'SRADynamic', 'SPPS_NotOverriden',
    'DISPID_SPRulesItem', 'SpeechRecognitionType', 'SPFILEMODE',
    'DISPID_SpeechPhraseAlternates', 'SpeechVoiceSpeakFlags',
    'DISPID_SVEWord', 'SPLEXICONTYPE', 'DISPID_SLPPartOfSpeech',
    'SPAR_Medium', 'SpeechPropertyNormalConfidenceThreshold',
    'SAFTNoAssignedFormat', 'SAFT22kHz16BitMono', 'SVP_10',
    'SPEI_END_INPUT_STREAM', 'DISPID_SGRSTNextState',
    'DISPID_SMSAMMHandle', 'SPEI_VOICE_CHANGE', 'SpResourceManager',
    ...
    'SpeechRuleState', 'SAFTCCITT_ALaw_8kHzMono',
    'DISPID_SRSClsidEngine', 'SVPNormal', 'ISpGrammarBuilder',
    ...
    'DISPID_SPEAudioStreamOffset', 'SINoSignal',
    'DISPID_SVEVoiceChange', 'DISPID_SRCEAdaptation',
    'DISPID_SPCPhoneToId', 'SPEI_SR_AUDIO_LEVEL', 'SVP_5',
    'SPDKL_LocalMachine', 'SPEI_END_SR_STREAM', 'SPSNoun',
    'DISPID_SGRAttributes', 'SDTPronunciation',
    'DISPID_SRRRecoContext', 'ISpRecoContext',
    ...
    'DISPID_SDKEnumKeys', 'SVSFIsFilename', 'ISpeechPhraseProperty',
    ...
    'SpeechPropertyResourceUsage', 'SPEVENT', 'ISpeechGrammarRule',
    'STSF_FlagCreate', 'DISPID_SpeechVoice',
    'IInternetSecurityMgrSite', 'SVSFParseSapi', 'STSF_LocalAppData',
    'SPPS_Unknown', 'DISPID_SVResume', 'SVSFUnusedFlags',
    'SPAUDIOSTATUS', 'SpeechAudioFormatGUIDText', 'tagSTATSTG',
    'DISPID_SRCEInterference', 'SFTSREngine', 'SPWF_SRENGINE',
    'ISpRecoGrammar', 'SP_VISEME_1', 'SVSFDefault', 'SVPAlert',
    'DISPID_SLPType', 'SAFTADPCM_44kHzMono',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'eLEXTYPE_RESERVED4', 'DISPID_SGRsFindRule', 'DISPID_SOTDataKey',
    'SASClosed', 'SP_VISEME_17', 'ISpeechRecoResult',
    'tagSPPROPERTYINFO', 'DISPID_SpeechDataKey', 'SVP_16',
    'SAFT32kHz8BitStereo', 'SPEI_RESERVED2', 'SPEI_TTS_AUDIO_LEVEL',
    'eLEXTYPE_RESERVED10', 'DISPID_SOTRemoveStorageFileName',
    'SPCS_DISABLED', 'DISPID_SpeechLexicon', 'DISPID_SVVoice',
    'DISPID_SAFType', 'SPEI_ADAPTATION', 'SRSActiveAlways',
    'eLEXTYPE_PRIVATE10', 'SpeechRecognizerState',
    'SAFTCCITT_ALaw_11kHzStereo', 'eLEXTYPE_APP',
    'DISPID_SOTIsUISupported', 'ISpeechRecognizer',
    'SDA_Two_Trailing_Spaces', 'SpeechEngineConfidence',
    'SPADAPTATIONRELEVANCE', 'DISPID_SGRsCommitAndSave',
    'eLEXTYPE_PRIVATE4', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SPISaveToMemory', 'DISPID_SGRSAddRuleTransition',
    'SPPS_Noncontent', 'DISPID_SOTCSetId', 'DISPID_SWFEBlockAlign',
    'SPAR_Low', 'SAFTADPCM_22kHzMono', 'DISPID_SVGetProfiles',
    'DISPID_SPRuleChildren', 'DISPID_SPIProperties', 'SPPS_Noun',
    'ISpeechDataKey', 'SAFTGSM610_11kHzMono', 'SpeechDataKeyLocation',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SpFileStream', 'SRTStandard',
    'DISPID_SRSetPropertyString',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SpeechObjectTokens',
    'SVF_None', 'DISPID_SABIMinNotification',
    'SpeechCategoryAppLexicons', 'DISPID_SVStatus', 'ISpRecognizer',
    'SP_VISEME_20', 'SREPrivate', 'DISPID_SPRuleName',
    'DISPID_SpeechPhraseInfo', 'SPAO_NONE',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPVPRI_ALERT',
    'SVSFPurgeBeforeSpeak', 'ISpeechObjectToken',
    'eLEXTYPE_PRIVATE11', 'SpeechUserTraining', 'DISPID_SRCState',
    'SDTDisplayText', 'Speech_Max_Word_Length', 'ISpNotifySource',
    'SVP_3', 'DISPID_SABIEventBias', 'DISPID_SASCurrentSeekPosition',
    'SRSInactiveWithPurge', 'SPGRAMMARSTATE',
    ...
    'DISPID_SASCurrentDevicePosition', 'SPRULE', 'SAFT48kHz16BitMono',
    'DISPID_SRRGetXMLErrorInfo', 'SSSPTRelativeToStart',
    'ISpMMSysAudio', 'SPPHRASERULE', 'SPSFunction',
    'DISPID_SpeechObjectTokenCategory',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SVSInputSentenceLength', 'SGRSTTWildcard', 'SPEI_MIN_SR',
    'SP_VISEME_10', 'DISPID_SPEs_NewEnum', 'DISPID_SRDisplayUI',
    'SP_VISEME_8', 'SPFM_OPEN_READWRITE', 'SGRSTTRule', 'SVP_19',
    'SpeechWordType', 'SLOStatic', 'DISPID_SpeechAudioBufferInfo',
    'SAFTADPCM_8kHzStereo', 'DISPID_SLGetWords',
    'SpeechPropertyResponseSpeed', 'DISPID_SFSClose',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SpeechRecoResult2', 'SPWT_DISPLAY', 'SDTAudio',
    'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SPPName', 'SBOPause',
    'SAFT24kHz8BitMono', 'SVP_4', 'DISPID_SWFEChannels',
    'SECFDefault', 'DISPID_SRCVoicePurgeEvent', 'DISPID_SMSSetData',
    'SpeechDictationTopicSpelling', 'SPEI_START_SR_STREAM',
    'SSTTDictation', 'SpeechCategoryAudioIn',
    'DISPID_SOTGetDescription', 'DISPID_SOTsItem',
    'SDKLCurrentConfig', 'SpeechWordPronounceable',
    'SpNullPhoneConverter', 'SVP_14', 'DISPID_SRCResume',
    '__MIDL_IWinTypes_0009', 'ISpeechGrammarRuleState',
    'ISpeechLexiconWords', 'DISPID_SOTDisplayUI', 'SVP_17',
    'DISPID_SWFEExtraData', 'SPSHT_Unknown', 'DISPID_SPIGetText',
    'eLEXTYPE_PRIVATE20', 'SpVoice', 'SPCONTEXTSTATE',
    '_ISpeechVoiceEvents', 'DISPID_SRCPause', 'ISpeechResourceLoader',
    'SAFT24kHz16BitMono', 'ISpeechObjectTokens', 'DISPID_SGRId',
    'ISpeechGrammarRuleStateTransitions', 'SREStreamStart',
    'eWORDTYPE_DELETED', 'DISPID_SPAPhraseInfo', 'SGSEnabled',
    ...
    'ISpeechLexiconPronunciations', 'SREStreamEnd', 'SRERecognition',
    'SP_VISEME_12', 'DISPID_SVVolume', 'SpeechTokenValueCLSID',
    'DISPID_SRCVoice', 'SSSPTRelativeToEnd', 'SRAORetainAudio',
    'DISPID_SPRulesCount', 'DISPID_SDKSetStringValue', 'ISpeechVoice',
    'DISPID_SPIEnginePrivateData', 'DISPID_SRRDiscardResultInfo',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SPAs_NewEnum',
    'DISPID_SMSADeviceId', 'SP_VISEME_3', 'ISpPhraseAlt',
    'SAFT8kHz16BitMono', 'SPSInterjection', 'ISpeechRecoContext',
    'SGSExclusive', 'DISPID_SpeechPhraseReplacement',
    'SECHighConfidence', 'DISPID_SOTs_NewEnum',
    'SAFTExtendedAudioFormat', 'SpeechLoadOption',
    'DISPID_SVEBookmark', 'eLEXTYPE_PRIVATE13', 'eLEXTYPE_PRIVATE16',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SpeechXMLRecoResult',
    'ISpeechWaveFormatEx', 'SPEI_START_INPUT_STREAM', 'SP_VISEME_13',
    'SVEEndInputStream', 'DISPID_SRGIsPronounceable', 'SPGS_ENABLED',
    'DISPID_SPEDisplayText', 'IEnumSpObjectTokens',
    'DISPID_SBSFormat', 'DISPID_SLGetGenerationChange',
    'DISPID_SLPsCount', 'SSFMOpenForRead',
    'SpeechGrammarRuleStateTransitionType', 'SINoise',
    'DISPID_SRCSetAdaptationData', 'STCInprocServer',
    'eLEXTYPE_PRIVATE1', 'SPBO_NONE', 'SREAllEvents',
    'DISPID_SVSVisemeId', 'SpeechLexiconType',
    'Speech_StreamPos_Asap', 'SpeechInterference',
    'SpeechAudioFormatGUIDWave', 'SPRULESTATE',
    'DISPID_SAEventHandle', 'SPINTERFERENCE_NONE',
    'SpObjectTokenCategory', 'SPSSuppressWord',
...
_check_version('1.1.14', 1652399661.101025)
